...
{
    /// <summary>
    /// Shopify platform service implementation with environment-based credentials.
    /// </summary>
    public class ShopifyPlatformService : IPlatformService
    {
        ...
        public ShopifyPlatformService(EnvironmentSecretProvider secretProvider, HttpClient httpClient)
        {
